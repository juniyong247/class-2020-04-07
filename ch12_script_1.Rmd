...
x %>% summarize(correlation = cor(faculty, earnings))
x %>% summarize(correlation = cor(sat, earnings))
...
causal effect: will reduce earnings for students depending on the school 10 years later for upper-tier schools, whereas for worse ones, it'll be ok?? 
Units: earnings
Treatments: financial aid given or not 
outcome: avg sat score

Causal effect: policy change leads to reduced median earnings

Fundamental problem: you can't have the treatment and the control on the same thing i.e. can't have financial aid but not have it at the same time for one variable

Assumption for causation: sampling has to be done randomly 
...
```{r}
-2590.82 + 50 * 0.3853723	+ 1400 * 24.4804028

-2590.82 + 50 * 0.3853723	+ 1300 * 24.4804028
